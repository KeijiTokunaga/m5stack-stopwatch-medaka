...
M5Stack StopWatch C152を、メダカ・ネオンテトラ・グッピーが各3匹と、大きなエンゼルフィッシュ1匹、合計10匹が泳ぐ小さな水槽にする観賞用アプリです。加速度と3軸ジャイロを使い、本体を揺らす・ひねる動きに水面と水草が反応します。
...
| エンゼルフィッシュ × 1 | 大きな銀色の体と縞模様、長いひれ。ゆったり泳ぐ水槽の主役 |

4種類ともボタンで投入したエサに集まります。魚の特徴を表現した観賞用の演出です。
...
エサは水面からゆっくり沈み、4種類の魚が近くの粒に集まって食べます。食べ終わると通常の遊泳に戻ります。1回6粒、同時に最大24粒まで。投入間隔は最低0.35秒で、食べ残しは24秒で消えます。長押しで明るさを変えた場合はエサを投入しません。

![4種類の魚がエサに集まるプレビュー](docs/feeding.gif)
...
- 各魚種だけの水槽でも6粒すべてを15秒以内に消費。4種類混泳での10分相当の耐久テストも通過。
